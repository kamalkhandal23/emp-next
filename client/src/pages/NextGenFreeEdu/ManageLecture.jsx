...
function ManageLecture() {
    ...
    const fetchLectures = async () => {
      try {
        const response = await fetch(
          `https://emp-new-iksg-git-main-teamoflifeboxs-projects.vercel.app/api/nextgen/courses/${selectedCourse}`
        );
  ...
  const deleteLecture = async (lectureId) => {
    ...
    try {
      const token = localStorage.getItem("authToken")
      const response = await fetch(
        `https://emp-new-iksg-git-main-teamoflifeboxs-projects.vercel.app/api/nextgen/lectures/${lectureId}`,
        { 
          method: "DELETE",
          headers: { 
  ...
  const updateLecture = async (lecture) => {
    try {
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `https://emp-new-iksg-git-main-teamoflifeboxs-projects.vercel.app/api/nextgen/lectures/${lecture._id}`,
        {
          method: "PUT",
          headers: { 
            "Content-Type": "application/json",
