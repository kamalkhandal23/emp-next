...
function CreateAssignment() {
  ...
  const handleFinalizeAssignment = async () => {
    ...
    if (!allQuestionsFilled) {
      alert('⚠️ Please fill in all question details before finalizing the assignment.');
      return;
    }
    ...
    try {
      ...
      setSubmitError(error.message || 'Failed to create assignment. Please try again.');
      alert(`❌ Error: ${error.message || 'Failed to create assignment. Please try again.'}`);
    } finally {
        ...
        {!submitted ? (
          <div className="max-w-md mx-auto p-8 bg-blue-50 border border-blue-200 rounded-lg shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <button
                type="submit"
                disabled={totalQuestions < 1 || !assignmentName.trim() || !courseName.trim()}
              ...
              <div className="mt-8 text-center">
                ...
                {submitSuccess && (
                  <div className="mb-4 p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg">
                    <p className="font-semibold">✅ Assignment created successfully!</p>
                    <p>Redirecting...</p>
                  </div>
                )}
