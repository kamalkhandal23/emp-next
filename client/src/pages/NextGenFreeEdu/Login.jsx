        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          <div className="services-grid">
            ...
            <div className="service-card">
              ...
              <div style={{ fontSize: '0.875rem', color: '#6b7280', lineHeight: '1.6' }}>
                <div style={{ marginBottom: '0.75rem', paddingBottom: '0.75rem', borderBottom: '1px solid #f3f4f6' }}>
                  <div style={{ fontWeight: '500', color: '#374151' }}>Completed: JavaScript Basics</div>
                  <div>Score: 92% • 2 days ago</div>
                </div>
                <div style={{ marginBottom: '0.75rem', paddingBottom: '0.75rem', borderBottom: '1px solid #f3f4f6' }}>
                  <div style={{ fontWeight: '500', color: '#374151' }}>Submitted: Portfolio Project</div>
                  <div>Status: Under Review • 3 days ago</div>
                </div>
                <div>
                  <div style={{ fontWeight: '500', color: '#374151' }}>Attended: Live Session</div>
            ...
            <div className="service-card">
              ...
              <div style={{ fontSize: '0.875rem', color: '#6b7280', lineHeight: '1.6' }}>
                <div style={{ marginBottom: '0.75rem', paddingBottom: '0.75rem', borderBottom: '1px solid #f3f4f6' }}>
                  <div style={{ fontWeight: '500', color: '#374151' }}>Live Session: Redux Deep Dive</div>
                  <div>Tomorrow, 7:00 PM IST</div>
                </div>
                <div style={{ marginBottom: '0.75rem', paddingBottom: '0.75rem', borderBottom: '1px solid #f3f4f6' }}>
                  <div style={{ fontWeight: '500', color: '#374151' }}>Assignment Due: API Integration</div>
                  <div>In 3 days</div>
                </div>
                <div>
                  <div style={{ fontWeight: '500', color: '#374151' }}>Mid-term Assessment</div>
                  <div>Next week</div>
                </div>
              </div>
            </div>
            ...
            <div className="service-card">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '2rem', fontWeight: '700', color: '#22c55e' }}>92%</div>
                ...
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '2rem', fontWeight: '700', color: '#8b5cf6' }}>8</div>
    ...
    <div className="container" style={{ paddingTop: '2rem', paddingBottom: '2rem' }}>
      <div style={{ maxWidth: '500px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <h3 style={{ color: '#0369a1', fontSize: '0.875rem', marginBottom: '0.5rem' }}>
            Demo Credentials (for testing):
          </h3>
          <div style={{ fontSize: '0.75rem', color: '#0c4a6e', lineHeight: '1.4' }}>
            <div><strong>Email:</strong> demo@student.com</div>
