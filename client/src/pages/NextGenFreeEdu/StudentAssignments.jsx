...
export default function StudentAssignments() {
  ...
  const courseNames = ['all', ...new Set(assignments.map(a => a.courseName))];
    ...
    return (
      <div className="container" style={{ paddingTop: '2rem', paddingBottom: '2rem' }}>
        <div style={{ textAlign: 'center', padding: '3rem' }}>
          ...
          <p style={{ color: '#6b7280', fontSize: '1.125rem' }}>Loading assignments...</p>
        </div>
      </div>
    );
  }
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <div>
                ...
                <p style={{ color: '#991b1b', fontSize: '0.875rem', margin: '0.25rem 0 0 0' }}>
                  {error}
                </p>
              </div>
            </div>
        ...
        {filteredAssignments.length === 0 ? (
          <div className="service-card" style={{ textAlign: 'center', padding: '3rem' }}>
            ...
            <h3 style={{ color: '#374151', marginBottom: '0.5rem' }}>No Assignments Found</h3>
            ...
            {filteredAssignments.map((assignment) => {
              ...
              return (
                <div 
                  ...
                  style={{
                    border: isStudentCourse ? '2px solid #3b82f6' : '1px solid #e5e7eb',
                    background: isStudentCourse ? 'linear-gradient(135deg, #f0f9ff, #ffffff)' : '#ffffff'
                  }}
                >
                  {/* Course Badge */}
                  ...
                  <div style={{ 
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
                      <span>📊</span>
                      <span><strong>{assignment.totalQuestions}</strong> Questions</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
                      <span>📅</span>
                  ...
                  <div style={{ display: 'flex', gap: '0.75rem', flexDirection: 'column' }}>
                    <button 
                      ...
                      onClick={() => {
                        ...
                        alert(`Starting assignment: ${assignment.assignmentName}`);
                      }}
                    >
                      Start Assignment
                    </button>
        ...
        <div style={{
          ...
          <h3 style={{ color: '#0369a1', marginBottom: '1rem', fontSize: '1.125rem' }}>
          ...
          <ul style={{ 
            ...
            <li>You can view all published assignments from different courses</li>
            <li>Make sure to submit your work before the deadline</li>
            <li>Contact support if you have any questions about an assignment</li>
          </ul>
        </div>
      </div>
    </div>
