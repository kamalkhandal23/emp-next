...
export default function TestConnection() {
  ...
  const testConnection = async () => {
    try {
      ...
      const response = await fetch('https://emp-new-iksg-git-main-teamoflifeboxs-projects.vercel.app/api')
    ...
    <div style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ background: '#f8fafc', padding: '1rem', borderRadius: '0.5rem' }}>
        ...
        <ol>
          ...
          <li>The server should be accessible at https://emp-new-iksg-git-main-teamoflifeboxs-projects.vercel.app/api</li>
