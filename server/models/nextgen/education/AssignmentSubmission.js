...
assignmentSubmissionSchema.statics.hasCompleted = async function (
  studentId,
  assignmentId
) {
...
assignmentSubmissionSchema.statics.getSubmission = async function (
  studentId,
  assignmentId
) {
...
const AssignmentSubmission =
  mongoose.models.NG_AssignmentSubmission ||
