...
const meetingSchema = new mongoose.Schema({
  ...
  attendees: [{
    ...
    status: { type: String, enum: ['invited', 'accepted', 'declined', 'tentative', 'attended', 'absent'], default: 'invited' },
    responseAt: Date,
  ...
  type: { type: String, enum: ['standup', 'review', 'planning', 'retrospective', 'one-on-one', 'all-hands', 'client', 'interview', 'training', 'other'], default: 'other' },
  location: {
